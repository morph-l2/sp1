...
impl Bn254FieldOperation {
    pub const fn to_field_operation(&self) -> FieldOperation {
        match self {
            ...
            Bn254FieldOperation::MulAdd => panic!("not supported"),
            Bn254FieldOperation::Invalid => panic!("Invalid"),
        }
    }
}
...
pub fn create_bn254_scalar_arith_event(
    ...
    let arg2 = match op {
        ...
        Bn254FieldOperation::MulAdd => FieldArithMemoryAccess::read(rt, arg2, 2),
